...
@section('title', "Edit $experience->company_name")
...
@section('content')
     <div class="page-content"> 
       <div class="page-header">
	      <div class="row">
   	   	  	    <div class="col-md-12">
   	   	  	       <h1 class="text-center">Edit Experience : {{ $experience->company_name }}</h1>
   	   	  	    </div>
	   	  </div>
	   </div>
			   ...
			   <div class="panel panel-primary"> 
			     <div class="panel-body"> 
			       {!! Form::model($experience,['route' => ['experiences.update', $experience->id],  'method' => 'PATCH']) !!}
			          @include('admin.experiences.form', ['btn' => 'Save', 'classes' => 'btn-primary btn-xs btn-block'])
			       {!! Form::close() !!}
			     </div>
			   </div>
			</div>
